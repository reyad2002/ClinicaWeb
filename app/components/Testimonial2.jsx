...
const TestimonialSection = () => {
  ...
  return (
    <div className="px-4 py-8 sm:py-8 bg-main overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <span className="inline-block  px-3 rounded-full bg-primary/10  text-white   text-md sm:text-2xl font-bold uppercase tracking-wider">
            Testimonials
          </span>
